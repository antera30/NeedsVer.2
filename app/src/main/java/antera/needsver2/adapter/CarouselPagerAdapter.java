package antera.needsver2.adapter;
...
public class CarouselPagerAdapter extends FragmentPagerAdapter implements ViewPager.OnPageChangeListener {
    ...
    public CarouselPagerAdapter(HomeFragment context, FragmentManager fm) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        try {
            ...
            position = position % HomeFragment.count;
    ...
    public int getCount() {
        int count = 0;
        try {
            count = HomeFragment.count * HomeFragment.LOOPS;
        } catch (Exception e) {
