...
public class ItemFragment extends Fragment {
    ...
    public static Fragment newInstance(HomeFragment context, int pos, float scale) {
        ...
        return Fragment.instantiate(context.getContext(), ItemFragment.class.getName(), b);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        LinearLayout linearLayout = (LinearLayout) inflater.inflate(R.layout.fragment_carousel, container, false);
